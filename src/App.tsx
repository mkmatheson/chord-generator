    ...
    <div className="App">
      <section className="builder">
        ...
        <div className="column">
          TODOS:
          <ul>
            <li>Catchall: If something's broken it's because I haven't felt inspired to fix it</li>
            ...
            <li>Sine is the only waveform available, despite the lies the dropdown displays.</li>
          </ul>
        </div>
      </section>
